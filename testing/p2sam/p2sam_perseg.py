...
def get_arguments():
    ...
    parser.add_argument('--feature-encoder', type=str, default='sam', choices=['sam', 'dinov3'])
    parser.add_argument('--dinov3-model-name', type=str, default=None)
    parser.add_argument('--dinov3-image-size', type=int, default=518)
    parser.add_argument('--dinov3-output-size', type=int, default=64)
    parser.add_argument('--dinov3-precision', type=str, default='fp32', choices=['fp32', 'fp16'])
    parser.add_argument('--dinov3-no-pretrained', action='store_true')
    parser.add_argument('--dinov3-sim-weight', type=float, default=0.5)
    parser.add_argument('--dinov3-sim-gain', type=float, default=1.0)
    parser.add_argument('--feat-aggregation', type=str, default='mean_max', choices=['mean', 'max', 'mean_max'])
